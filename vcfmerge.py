...
def __main__():
   ...
   parser.add_argument("--mutect_vcf",dest = "mutect_vcf", help='VCF input file with somatic query variants (SNVs) called with MuTect (version 1.x).')
   parser.add_argument("--strelka_snv_vcf", dest = "strelka_snv_vcf", help='VCF input file with somatic query variants (SNVs) called with Strelka (version 1.x).')
   parser.add_argument("--strelka_indel_vcf", dest = "strelka_indel_vcf", help="VCF input file with somatic query variants (InDels) called with Strelka (version 1.x)")
